...
define(co0, -43)		! Constant of the polynomial
define(co1, -27)		! Coefficient to x in the polynomial
define(co2, 27)	! Coefficient to x^2 in the polynomial
define(co3, 5)		! Coefficient to x^3 in the polynomial

define(c, -6)		! Lower limit of the domain
define(b, -7)		! Starting point for program
define(e, 6)		! Upper limit of the domain
